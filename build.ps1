...
$compile = "rc /nologo /fo `"$resourceOutput`" resources\KBUN.rc && " +
    ...
    "advapi32.lib comdlg32.lib comctl32.lib dwmapi.lib gdi32.lib ole32.lib oleaut32.lib shell32.lib shlwapi.lib uiautomationcore.lib user32.lib uxtheme.lib"
